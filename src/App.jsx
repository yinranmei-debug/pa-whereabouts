...
<button
            ...
            <div style={{ position: 'relative' }}>
              <div className="user-chip" style={{ cursor: 'pointer' }} onClick={() => setShowStreakDropdown(v => !v)}>
                ...
                {(() => {
                  const navStreak = computeStreak(meStaff?.id, records);
                  const lvl = LEVELS[streakToLevelIdx(navStreak)];
                  return (
            ...
            >
              ...
              <div className={`apac-toggle-track${showApacHolidays?' apac-toggle-on':''}`} style={{
                ...
                <div className="apac-toggle-thumb" style={{
                  ...
                  left: showApacHolidays ? 13 : 1,
                  transition:'left 0.2s cubic-bezier(0.34,1.56,0.64,1), background 0.2s',
                  boxShadow: showApacHolidays ? '0 0 4px rgba(106,199,255,0.8)' : 'none',
                }}/>
              </div>
            </button>
          )}
