...
const GlobalStyles = () => (
  <style>{`
    ...
    *,*:before,*:after{box-sizing:border-box;margin:0;padding:0}
    ...
    .nav-tab{
      height:${NAV_H}px;display:flex;align-items:center;padding:0 14px;
    ...
    /* ── SUB HEADER ── */
    .sub-header{
      height:${SUB_H}px;padding:0 28px;
      background:rgba(255,255,255,0.85);
      backdrop-filter:blur(12px);
      -webkit-backdrop-filter:blur(12px);
      border-bottom:1px solid rgba(229,231,235,0.8);
    ...
    .team-summary{
      ...
      margin-left:auto;
      padding:5px 14px;
      background:linear-gradient(90deg,rgba(0,155,255,0.08),rgba(119,11,255,0.08));
      border:1px solid rgba(119,11,255,0.12);
      border-radius:100px;
    ...
    /* card wrapper — no overflow:hidden to preserve sticky */
    .tbl-card{
      background:#fff;
      border-radius:24px;
    ...
    .tbl-hdr-row{
      ...
      min-width:860px;padding:0 24px;
    }
    .tbl-hdr-namecol{background:transparent;}
    .tbl-hdr-daycol{padding:14px 4px 10px;text-align:center;background:transparent;}
    ...
    .nw{
      ...
      padding:0 8px;border-bottom:1px solid rgba(226,232,240,0.6);
      overflow:visible;
    }
    ...
    .n-av-wrap.is-me:hover{
      transform:scale(1.18) rotate(3deg);
      filter:drop-shadow(0 8px 16px rgba(119,11,255,0.22));
    }
    ...
    .n-name{font-size:13px;font-weight:500;color:#374151;transition:color 0.15s;}
    ...
    .dw{
      height:${ROW_H}px;display:flex;flex-direction:column;
    ...
    .sh.mine:hover{
      background:linear-gradient(135deg,#dde5fe,#ede9fe);
      box-shadow:0 4px 12px rgba(119,11,255,0.1);
    ...
    .sh.cell-snap{animation:cellSnap 0.38s cubic-bezier(0.34,1.56,0.64,1) both;}
    .sh.cell-stagger{animation:cellStagger 0.28s cubic-bezier(0.34,1.56,0.64,1) both;}

    .s-drop{
      position:absolute;top:44px;left:0;z-index:10001;
      background:#fff;border-radius:14px;width:200px;padding:6px;
    ...
    /* holiday/weekend pill columns */
    td.ptd{height:1px;padding:0 6px;vertical-align:top;position:relative;}
    .pill{
      height:100%;width:100%;
      display:flex;flex-direction:column;align-items:center;justify-content:flex-start;
      cursor:pointer;user-select:none;overflow:hidden;border-radius:14px;
    }
    .pill-card{
    ...
    .plan-row{
      padding:9px 11px;margin-bottom:4px;border-radius:10px;
    ...
    .plan-row:hover .plan-date{
      background:linear-gradient(90deg,#009bff,#770bff);
      -webkit-background-clip:text;background-clip:text;color:transparent;
    }

    /* login / access denied screens */
    .ms-screen{min-height:100vh;display:flex;align-items:center;justify-content:center;background:#F8FAFC;}
    .ms-card{
      background:#fff;border-radius:20px;padding:44px;max-width:420px;width:90%;
    ...
    .ms-err{
      margin-top:14px;color:#a4262c;background:#fde7e9;
