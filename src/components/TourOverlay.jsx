...
const STEPS = [
  ...
  },
  {
    id: 'apac',
    title: 'APAC Holidays',
    desc: 'Toggle the APAC flag to reveal regional public holidays inline in the calendar. Handy for knowing when your colleagues across the region are off.',
    position: 'bottom-left',
...
export default function TourOverlay({ onDone }) {
  ...
  const stepIcons = {
    ...
    apac:         <svg width="28" height="28" viewBox="0 0 24 24" fill="none"><rect x="3" y="5" width="18" height="15" rx="2" fill="rgba(96,208,255,0.15)" stroke="rgba(96,208,255,0.6)" strokeWidth="1.2"/><rect x="3" y="5" width="18" height="4" rx="2" fill="rgba(96,208,255,0.3)"/><rect x="3" y="7" width="18" height="2" fill="rgba(96,208,255,0.3)"/><rect x="7" y="3" width="2" height="4" rx="1" fill="rgba(167,139,250,0.9)"/><rect x="15" y="3" width="2" height="4" rx="1" fill="rgba(96,208,255,0.9)"/><rect x="7" y="13" width="3" height="3" rx="0.5" fill="rgba(255,200,80,0.8)"/><rect x="14" y="13" width="3" height="3" rx="0.5" fill="rgba(255,120,120,0.8)"/></svg>,
