...
const STEPS = [
  ...
  },
  {
    ...
    desc: "Switch between the cosmic night view and a clean, bright day mode — whatever helps you focus best. Your preference is saved automatically.",
    position: 'bottom-left',
    highlight: () => document.querySelector('.theme-toggle-btn'),
  },
  {
    id: 'hub-bday',
  ...
  },
  {
    id: 'team-today',
    title: 'Team Today',
    desc: "See who's in, who's out, and where everyone is right now — a live snapshot of the whole team.",
    position: 'bottom-left',
    highlight: () => document.querySelector('.team-today-btn'),
  },
  {
    id: 'apac',
    title: 'APAC Holidays',
    desc: 'Toggle to show JP & KR public holidays inline in the calendar — so you always know when your regional colleagues are off.',
    position: 'bottom-left',
    highlight: () => document.querySelector('.apac-hol-btn'),
  },
];
...
export default function TourOverlay({ onDone }) {
  ...
  const stepIcons = {
    ...
    apac:         <svg width="28" height="28" viewBox="0 0 24 22" fill="none"><path d="M3 15 Q12 3 21 15" fill="none" stroke="rgba(106,199,255,0.8)" strokeWidth="1.6" strokeLinecap="round"/><path d="M2 18 Q12 23 22 18" fill="none" stroke="rgba(106,199,255,0.5)" strokeWidth="1.3" strokeLinecap="round"/><circle cx="15.5" cy="10" r="2.8" fill="rgba(220,50,70,0.9)"/><circle cx="9.5" cy="12" r="2.8" fill="rgba(40,100,220,0.9)"/><circle cx="12" cy="18.5" r="1.6" fill="rgba(167,139,250,0.9)"/></svg>,
    'team-today': <svg width="28" height="28" viewBox="0 0 24 21" fill="none"><circle cx="6.5" cy="6" r="3" fill="none" stroke="rgba(106,199,255,0.75)" strokeWidth="1.4"/><path d="M1 20 Q1 13.5 6.5 13.5 Q9 13.5 10.5 15.5" fill="none" stroke="rgba(106,199,255,0.65)" strokeWidth="1.4" strokeLinecap="round"/><circle cx="17.5" cy="6" r="3" fill="none" stroke="rgba(106,199,255,0.75)" strokeWidth="1.4"/><path d="M23 20 Q23 13.5 17.5 13.5 Q15 13.5 13.5 15.5" fill="none" stroke="rgba(106,199,255,0.65)" strokeWidth="1.4" strokeLinecap="round"/><circle cx="12" cy="5" r="3.6" fill="none" stroke="rgba(196,181,253,0.92)" strokeWidth="1.6"/><path d="M4.5 20.5 Q4.5 12.5 12 12.5 Q19.5 12.5 19.5 20.5" fill="none" stroke="rgba(167,139,250,0.82)" strokeWidth="1.6" strokeLinecap="round"/><circle cx="12" cy="20.5" r="1.5" fill="rgba(0,155,255,0.95)"/></svg>,
   celebrate:    <svg width="28" height="28" viewBox="0 0 24 24" fill="none"><rect x="2" y="4" width="20" height="16" rx="3" fill="rgba(90,10,50,0.6)" stroke="rgba(217,70,239,0.5)" strokeWidth="1.2"/><rect x="10" y="8" width="4" height="8" rx="1" fill="rgba(217,70,239,0.4)"/></svg>,
    theme:        <svg width="28" height="28" viewBox="0 0 24 24" fill="none"><circle cx="12" cy="12" r="5" fill="rgba(255,220,50,0.9)" stroke="rgba(255,183,0,0.7)" strokeWidth="1"/><line x1="12" y1="2" x2="12" y2="5" stroke="rgba(255,220,50,0.8)" strokeWidth="1.5" strokeLinecap="round"/><line x1="12" y1="19" x2="12" y2="22" stroke="rgba(255,220,50,0.8)" strokeWidth="1.5" strokeLinecap="round"/><line x1="2" y1="12" x2="5" y2="12" stroke="rgba(255,220,50,0.8)" strokeWidth="1.5" strokeLinecap="round"/><line x1="19" y1="12" x2="22" y2="12" stroke="rgba(255,220,50,0.8)" strokeWidth="1.5" strokeLinecap="round"/><line x1="4.9" y1="4.9" x2="7.1" y2="7.1" stroke="rgba(255,220,50,0.7)" strokeWidth="1.5" strokeLinecap="round"/><line x1="16.9" y1="16.9" x2="19.1" y2="19.1" stroke="rgba(255,220,50,0.7)" strokeWidth="1.5" strokeLinecap="round"/><line x1="4.9" y1="19.1" x2="7.1" y2="16.9" stroke="rgba(255,220,50,0.7)" strokeWidth="1.5" strokeLinecap="round"/><line x1="16.9" y1="7.1" x2="19.1" y2="4.9" stroke="rgba(255,220,50,0.7)" strokeWidth="1.5" strokeLinecap="round"/></svg>,
  };
