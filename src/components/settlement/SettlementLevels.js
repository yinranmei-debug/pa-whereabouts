...
export const LEVELS = [
  ...
  },
  {
    ...
    rule: 'You updated your status on 2+ days in a week — and your world began.',
    nudgeTemplate: (n, title) => `Update your status 2 days next week to unlock ${title}`,
    Scene: SceneL1,
  ...
  },
  {
    ...
    rule: 'You\'ve been showing up — 2 status updates a week, 3 weeks straight.',
    nudgeTemplate: (n, title) => `${n} more week${n > 1 ? 's' : ''} of 2-day updates to unlock ${title}`,
    Scene: SceneL2,
  ...
  },
  {
    ...
    rule: 'Six weeks of showing up. That\'s not routine — that\'s a community.',
    nudgeTemplate: (n, title) => `${n} more week${n > 1 ? 's' : ''} of 2-day updates to unlock ${title}`,
    Scene: SceneL3,
  ...
  },
  {
    ...
    rule: 'Ten weeks of 2-day status updates. You didn\'t just show up — you built this.',
    nudgeTemplate: (n, title) => `${n} more week${n > 1 ? 's' : ''} of 2-day updates to unlock ${title}`,
    Scene: SceneL4,
